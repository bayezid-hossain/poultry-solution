                            ...
                            <View className="space-y-6">
                                ...
                                <View className="gap-2 z-[60]">
                                    ...
                                    <View className="relative">
                                        ...
                                        {isFarmerOpen && (
                                            <View className="absolute top-16 left-0 right-0 bg-background border border-border/50 rounded-2xl shadow-xl z-[60] overflow-hidden max-h-60">
                                ...
                                <View className="gap-2 z-50">
                                    ...
                                    <View className="relative">
                                        ...
                                        {isBirdTypeOpen && (
                                            <View className="absolute bottom-16 left-0 right-0 bg-background border border-border/50 rounded-2xl shadow-xl z-50 overflow-hidden max-h-48">
                                                <ScrollView nestedScrollEnabled>
