                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <View className="flex-row justify-end gap-2 pt-1 border-t border-border/20">
                                            {isEditing ? (
                                                <>
                                                    <Button variant="ghost" size="sm" className="h-8 px-3 rounded-lg" onPress={() => setEditingLogId(null)}>
                                                        <Text className="text-xs font-bold text-muted-foreground">Cancel</Text>
                                                    </Button>
                                                    <Button variant="default" size="sm" className="h-8 px-4 rounded-lg bg-primary" onPress={handleSave} disabled={updateMutation.isPending}>
                                                ...
                                                <>
                                                    <Button variant="ghost" size="icon" className="h-8 w-8 rounded-lg" onPress={() => handleDelete(log.id)} disabled={deleteMutation.isPending}>
                                                        <Icon as={Trash2} size={14} className="text-destructive" />
                                                    </Button>
                                                    <Button variant="outline" size="sm" className="h-8 px-3 rounded-lg border-border/50" onPress={() => handleEdit(log)}>
