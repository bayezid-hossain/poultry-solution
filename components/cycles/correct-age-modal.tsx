...
interface CorrectAgeModalProps {
    cycleId: string;
    currentAge: number;
    open: boolean;
...
export function CorrectAgeModal({
    cycleId,
    currentAge,
    open,
    onOpenChange,
    onSuccess,
}: CorrectAgeModalProps) {
    ...
    const mutation = trpc.officer.cycles.correctAge.useMutation({
        onSuccess: () => {
            onOpenChange(false);
            onSuccess?.();
            setAge("");
                ...
                >
                    <View className="p-6 pb-2 flex-row justify-between items-center">
                        <View className="flex-row items-center gap-3">
                            ...
                            <View>
                                <Text className="text-xl font-bold text-foreground">Correct Age</Text>
                                <Text className="text-xs text-muted-foreground mt-0.5">
                                    Update cycle day age
                                </Text>
                            </View>
                        </View>
