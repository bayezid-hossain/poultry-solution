                ...
                <View className="gap-3">
                    {topPerformers.length === 0 ? (
                        ...
                        topPerformers.map((farmer, i) => {
                            return (
                                <View key={farmer.farmerId} className="flex-row items-center justify-between p-4 bg-muted/30 rounded-2xl border border-border/50">
                                    <View className="flex-row items-center gap-3">
                                        <View className={cn(
                                        ...
                                        <View>
                                            <Text className="font-black text-sm uppercase tracking-tight text-foreground">{farmer.farmerName}</Text>
